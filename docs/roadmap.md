...
telas do cadastro fiscal, dos documentos, de classificar e de corrigir, e o
...
| Telas de importar e gerar | Cadastro fiscal, documentos, classificar e corrigir têm tela; importar XML e gerar/transmitir a EFD seguem só na linha de comando | `src.dashboard.app:gerar_page` |
