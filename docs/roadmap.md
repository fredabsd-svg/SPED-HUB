...
telas de importar, dos documentos, de classificar, de corrigir e do cadastro
fiscal, e o comando `sped-hub fiscal` que alcança tudo isso; ver [`status.md`](status.md). Sobre a Reforma
...
| Tela de gerar e transmitir | Importar, documentos, classificar, corrigir e cadastro têm tela; gerar a EFD, ver o espelho e marcar a transmissão seguem só na linha de comando | `src.dashboard.app:gerar_page` |
