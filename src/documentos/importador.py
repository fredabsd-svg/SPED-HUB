...
class ImportadorDeDocumentos:
    ...
    def _gravar(
        ...
        documento = DocumentoFiscal(
            ...
            municipio_fg_ibs=normalizado.municipio_fg_ibs,
            ...
            valor_icms_desonerado=normalizado.valor_icms_desonerado,
            valor_fcp_st=normalizado.valor_fcp_st,
